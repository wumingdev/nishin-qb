...
QBClothing.ReloadOutfits = function(outfits) {
    ...
    $.each(outfits, function(index, outfit) {
        var elem = '<div class="clothing-menu-option" data-myOutfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitname + '</p></div><div class="clothing-menu-myOutfit-option-button"><p data-tkey="select">選擇</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p data-tkey="delete">刪除</p></div></div>'
    ...
    $.each(data.menus, function(i, menu) {
        ...
        if (menu.menu == "roomOutfits") {
            $.each(menu.outfits, function(index, outfit) {
                var elem = '<div class="clothing-menu-option" data-outfit="' + (index + 1) + '"> <div class="clothing-menu-option-header"><p>' + outfit.outfitLabel + '</p></div> <div class="clothing-menu-outfit-option-button"><p data-tkey="select">選擇服裝</p></div> </div>'
...
QBClothing.SetMaxValues = function(maxValues) {
    $.each(maxValues, function(i, cat) {
        if (cat.type == "character") {
            ...
            $(itemMax).html("<p><span data-tkey='item'>款式</span>: " + maxValues[containers.data('type')].item + "</p>");
            ...
            $(headerMax).html("<p><span data-tkey='texture'>類別</span>: " + maxValues[containers.data('type')].texture + "</p>");
