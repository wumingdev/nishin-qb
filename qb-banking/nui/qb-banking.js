...
function populateBanking(data)
{
    ...
    if(data.cardInformation !== undefined) {
        if (data.cardInformation.cardLocked == true) {
            ...
            $("#debitCardStatus").html('<div class="card-header">卡片凍結中</div><div class="card-body">你的卡片目前凍結中</div><div class="card-footer"><button class="btn btn-primary btn-block" id="unLockCard">解凍卡片</button></div>');
        } else {
            $("#debitCardStatus").removeClass('bg-danger');
        $("#debitCardStatus").addClass('bg-success');
        $("#debitCardStatus").html('<div class="card-header">卡片活耀中</div><div class="card-body">你的卡片目前活耀中</div><div class="card-footer"><button class="btn btn-primary btn-block" id="lockCard">凍結卡片</button></div>');
        }
...
$(function() {
    ...
    $(document).on('click','#lockCard',function(){
        $("#debitCardStatus").removeClass('bg-success');
        $("#debitCardStatus").addClass('bg-danger');
        $("#debitCardStatus").html('<div class="card-header">帳號凍結中</div><div class="card-body">你的帳號凍結中</div><div class="card-footer"><button class="btn btn-primary btn-block" id="unLockCard">解凍卡片</button></div>');
    ...
    $(document).on('click','#unLockCard',function(){
        $("#debitCardStatus").removeClass('bg-danger');
        $("#debitCardStatus").addClass('bg-success');
        $("#debitCardStatus").html('<div class="card-header">帳號活躍中</div><div class="card-body">你的帳號活躍中</div><div class="card-footer"><button class="btn btn-primary btn-block" id="lockCard">凍結卡片</button></div>');
