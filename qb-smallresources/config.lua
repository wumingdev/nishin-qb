...
Config.Consumables = {
    eat = { -- default food items
        ...
        ['sashimi'] = math.random(25, 30),
        ['hotdog'] =  math.random(30, 40),
        ['salmon_sashimi'] =  math.random(20, 30),
        ['salmon_sushi'] =  math.random(20, 30),
        ['tuna_sashimi'] =  math.random(20, 30),
        ['tuna_sushi'] =  math.random(20, 30),
        ['katsudon'] =  math.random(30, 40),
        ['tonkotsu_ramen'] =  math.random(30, 50),
        ['sukiyaki_udon'] =  math.random(30, 50),
        ['butter_crab'] =  math.random(30, 50),
        ['clean_soba'] =  math.random(30, 40),
        ['lemon_marlin'] =  math.random(30, 40),
        ['strawberry_cake'] =  math.random(30, 40),
        ['cat_ramen'] =  math.random(30, 40),
        ['cat_shrimp_rice'] =  math.random(30, 40),
        ['cat_yakiniku'] =  math.random(30, 50),
        ['cat_don'] =  math.random(30, 50),
        ['cat_bento'] =  math.random(30, 50),
        ['cat_sushi'] =  math.random(30, 40),
        ['emo_wang'] =  math.random(30, 40),
    },
    drink = { -- default drink items
        ['water_bottle'] = math.random(20, 30),
        ['kurkakola'] = math.random(20, 30),
        ...
        ['orange_juice']  = math.random(20, 30),
        ['bubble_tea']  = math.random(20, 30),
        ['go_hospital']  = math.random(20, 25),
        ['dream_poppy']  = math.random(20, 25),
        ['cat_puding']  = math.random(20, 25),
        ['cat_happy']  = math.random(25, 30),
        ['cat_coffee']  = math.random(25, 30),
    },
