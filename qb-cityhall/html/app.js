...
$(document).on("click", ".identity-page-block", function(e){
    ...
    if (selectedIdentity == null) {
        ...
        $(".request-identity-button").html(`<p>購買 $${selectedIdentityCost}</p>`);
        ...
        $(this).addClass("identity-selected");
        selectedIdentity = this;
        $(".request-identity-button").html("<p>購買</p>");
    }
});
...
// 設置點擊事件
// getPointButton.addEventListener('click', function(event) {
//     event.preventDefault();
//     // 向伺服器發送 claimItem 事件
//     $.post('https://qb-cityhall/claimItem', JSON.stringify({}));
// });

// document.addEventListener('DOMContentLoaded', function() {
//     var getPointButton = document.getElementById('getPointsButton');
...
document.addEventListener('DOMContentLoaded', function() {
    // console.log("geticon")
    var getPointsButton = document.getElementById('getPointsButton');

    getPointsButton.addEventListener('click', function(event) {
        // console.log("clickmoney")
        event.preventDefault();
        // 向伺服器發送 claimItem 事件
        $.post('https://qb-cityhall/qb-cityhall:client:claimItem', JSON.stringify({}));
        ResetPages();
    });
});
