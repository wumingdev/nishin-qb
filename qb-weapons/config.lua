...
Config.DurabilityMultiplier = {
    ...
    ['weapon_bottle']                = 0.50,
    ['weapon_crowbar']               = 0.50,
    ['weapon_candycane']             = 0.50,
    -- ['weapon_flashlight'] 			 = 0.50,
    ['weapon_golfclub']              = 0.50,
    ['weapon_hammer']                = 0.50,
    ['weapon_hatchet']               = 0.50,
    ['weapon_knuckle']               = 0.50,
    ['weapon_knife']                 = 0.50,
    ['weapon_machete']               = 0.50,
    ['weapon_switchblade']           = 0.50,
    -- ['weapon_nightstick'] 			 = 0.50,
    ['weapon_wrench']                = 0.50,
    ['weapon_battleaxe']             = 0.50,
    ['weapon_poolcue']               = 0.50,
    ['weapon_briefcase']             = 0.50,
    ['weapon_briefcase_02']          = 0.50,
    ['weapon_garbagebag']            = 0.50,
    ['weapon_handcuffs']             = 0.50,
    ['weapon_bread']                 = 0.50,
    ['weapon_stone_hatchet']         = 0.50,
    ...
    -- ['weapon_stungun'] 				 = 0.50,
    -- ['weapon_stungun_mp'] 				 = 0.50,
    ['weapon_pistol50']              = 0.50,
    ['weapon_snspistol']             = 0.50,
    ['weapon_heavypistol']           = 0.50,
    ['weapon_vintagepistol']         = 0.50,
    ['weapon_flaregun']              = 0.50,
    ['weapon_marksmanpistol']        = 0.50,
    ['weapon_revolver']              = 0.50,
    ['weapon_revolver_mk2']          = 0.50,
    ['weapon_doubleaction']          = 0.50,
    ['weapon_snspistol_mk2']         = 0.50,
    ['weapon_raypistol']             = 0.50,
    ['weapon_ceramicpistol']         = 0.50,
    ['weapon_navyrevolver']          = 0.50,
    ['weapon_gadgetpistol']          = 0.50,
    ['weapon_pistolxm3']             = 0.50,

    -- Submachine Guns
    ['weapon_microsmg']              = 0.50,
    ['weapon_smg']                   = 0.50,
    ['weapon_smg_mk2']               = 0.50,
    ['weapon_assaultsmg']            = 0.50,
    ['weapon_combatpdw']             = 0.50,
    ['weapon_machinepistol']         = 0.50,
    ['weapon_minismg']               = 0.50,
    ['weapon_raycarbine']            = 0.50,

    -- Shotguns
    ['weapon_pumpshotgun']           = 0.50,
    ['weapon_sawnoffshotgun']        = 0.50,
    ['weapon_assaultshotgun']        = 0.50,
    ['weapon_bullpupshotgun']        = 0.50,
    ['weapon_musket']                = 0.50,
    ['weapon_heavyshotgun']          = 0.50,
    ['weapon_dbshotgun']             = 0.50,
    ['weapon_autoshotgun']           = 0.50,
    ['weapon_pumpshotgun_mk2']       = 0.50,
    ['weapon_combatshotgun']         = 0.50,

    -- Assault Rifles
    ['weapon_assaultrifle']          = 0.50,
    ['weapon_assaultrifle_mk2']      = 0.50,
    ['weapon_carbinerifle']          = 0.50,
    ['weapon_carbinerifle_mk2']      = 0.50,
    ['weapon_advancedrifle']         = 0.50,
    ['weapon_specialcarbine']        = 0.50,
    ['weapon_bullpuprifle']          = 0.50,
    ['weapon_compactrifle']          = 0.50,
    ['weapon_specialcarbine_mk2']    = 0.50,
    ['weapon_bullpuprifle_mk2']      = 0.50,
    ['weapon_militaryrifle']         = 0.50,
    ['weapon_heavyrifle']            = 0.50,

    -- Light Machine Guns
    ['weapon_mg']                    = 0.50,
    ['weapon_combatmg']              = 0.50,
    ['weapon_gusenberg']             = 0.50,
    ['weapon_combatmg_mk2']          = 0.50,

    -- Sniper Rifles
    ['weapon_sniperrifle']           = 0.50,
    ['weapon_heavysniper']           = 0.50,
    ['weapon_marksmanrifle']         = 0.50,
    ['weapon_remotesniper']          = 0.50,
    ['weapon_heavysniper_mk2']       = 0.50,
    ['weapon_marksmanrifle_mk2']     = 0.50,

    -- Heavy Weapons
    ['weapon_rpg']                   = 0.50,
    ['weapon_grenadelauncher']       = 0.50,
    ['weapon_grenadelauncher_smoke'] = 0.50,
    ['weapon_emplauncher']           = 0.50,
    ['weapon_minigun']               = 0.50,
    ['weapon_firework']              = 0.50,
    ['weapon_railgun']               = 0.50,
    ['weapon_hominglauncher']        = 0.50,
    ['weapon_compactlauncher']       = 0.50,
    ['weapon_rayminigun']            = 0.50,
    ['weapon_railgunxm3']            = 0.50,

    -- Throwables
    ['weapon_grenade']               = 0.50,
    ['weapon_bzgas']                 = 0.50,
    ['weapon_molotov']               = 0.50,
    ['weapon_stickybomb']            = 0.50,
    ['weapon_proxmine']              = 0.50,
    ['weapon_snowball']              = 0.50,
    ['weapon_pipebomb']              = 0.50,
    ['weapon_ball']                  = 0.50,
    ['weapon_smokegrenade']          = 0.50,
    ['weapon_flare']                 = 0.50,

    -- Miscellaneous
    ['weapon_petrolcan']             = 0.50,
    ['weapon_fireextinguisher']      = 0.50,
    ['weapon_hazardcan']             = 0.50,
    ['weapon_fertilizercan']         = 0.50,
}

Config.WeaponRepairPoints = {
    [1] = {
        coords = vector3(975.3576, -1253.6932, 18.2585),
        IsRepairing = false,
        RepairingData = {},
    },
}
